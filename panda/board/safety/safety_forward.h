...
uint16_t candidate_fp[3][20][3] = {
  ...
  // Toyota official? Giraffe (camera = bus2)
  { {0,36,8},{0,37,8},{0,170,8},{0,180,8},{0,426,6},{0,452,8},{0,466,8},{0,467,8},{0,552,4},{0,608,8},{0,643,7},{0,800,8},{0,835,8},{0,836,8},{0,869,7},{0,870,7},{0,921,8},{0,944,8},{0,945,8},{0,951,8},{0,955,8),{0,956,8},{0,1017,8} }
};
