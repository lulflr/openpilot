...
def get_cam_can_parser(CP):
  ...
  cam_bus = 1 # a ajuster si on a pas l'id 0xe4
...
class CarState(object):
  ...
  def update(self, cp, cp_cam):
    ...
    if self.CP.radarOffCan:
      ...
      self.v_cruise_pcm = cp.vl["MACCHINA"]['CRUISE_SPEED_PCM'] # self.v_cruise_pcm_prev if cp.vl["ACC_HUD"]['CRUISE_SPEED'] > 160.0 else cp.vl["ACC_HUD"]['CRUISE_SPEED']
    ...
    self.hud_lead = 1 # cp.vl["ACC_HUD"]['HUD_LEAD'] A changer ?
